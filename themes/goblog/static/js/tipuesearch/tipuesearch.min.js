...
if(c==1)
{out+='<div id="tipue_search_results_count" class="border-bottom">'+tipuesearch_string_4;}
else
{var c_c=c.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",");out+='<div id="tipue_search_results_count" class="border-bottom">'+c_c+' '+tipuesearch_string_5;}
if(set.showTime)
...
{out+='<div class="tipue_search_result border-bottom">';out+='<div class="tipue_search_content_title"><a href="'+found[i].url+'"'+tipue_search_w+'>'+found[i].title+'</a></div>';if(set.debug)
